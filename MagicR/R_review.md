...
###
```
srt@meta.data[, "seurat_cluster"]  # 这个是只取出seurat_cluster这一列的内容，不会包含行名，意思是把meta中的这一列所有行都取出来也就是取出一整列的意思
```
...
![image](https://github.com/wyyang-thy/Learning-Notes/blob/main/MagicR/%E5%BE%AE%E4%BF%A1%E5%9B%BE%E7%89%87_20260305211730_568_8.png)
